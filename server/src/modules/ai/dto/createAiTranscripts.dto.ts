...
@ApiSchema({
  ...
  description:
    "Data transfer object for creating one AI interview transcripts.",
})
class TranscriptItemDto {
  ...
  @ApiProperty({
    description: "Who stated the transcript",
...
@ApiSchema({
  ...
  description:
    "Data transfer object for creating multiple AI interview transcripts (an array of TranscriptItemDto).",
})
export class CreateAiTranscriptsDto {
  @ApiProperty({
    description: "Array of transcript items",
