  ...
  return (
    <div className="flex flex-col gap-4 py-8 px-6 max-w-92 w-full bg-white rounded-md shadow-lg">
      <header className="flex flex-col items-center justify-between mb-2">
        ...
        <p className="text-gray-500 text-sm font-semibold">Create a new account</p>
      </header>
      <form
      ...
      >
        <form.Field
          ...
          children={( field ) => (
            <div className="flex flex-col gap-2">
              <label htmlFor="username" className="text-gray-500 text-sm font-semibold">Username</label>
        ...
        <form.Field
          ...
          children={( field ) => (
            <div className="flex flex-col gap-2">
              <label htmlFor="confirmPassword" className="text-gray-500 text-sm font-semibold">Confirm Password</label>
              <div className="relative">
                <input
                  id="confirmPassword"
                  type="password"
